...
from metrics.api.serializers import SectionReportSerializer
from metrics.logic.report_manager import ReportManager
...
class SectionReportViewSet(viewsets.GenericViewSet):
    ...
    def get_common_section_report(self, request, course_id=None) -> Response:
        ...
        serializer = SectionReportSerializer(report, many=False)
